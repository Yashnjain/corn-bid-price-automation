...
def scrape_and_insert_gpreinc():
    try:
        ...
        WebDriverWait(driver, 20).until(EC.element_to_be_clickable((By.CLASS_NAME, "form-group")))
        select = Select(
...
def fetch_and_insert_regular_websitedata():
    try:
        ...
        bids = scrape_regular_website_2(url="https://kaapaethanolcommodities.com/Commodities/Cash-Bids", basis_index=5,
                                        month_index=1, find_by_option=1, row_start_index=3, table_index=2,
                                        class_name="cashbid_table cashbid_fulltable", row_end_index=8)
        ...
        print(sys.exc_info()[0])
        print("error occoured in fetch_and_insert_regular_websitedata"+e)
        logger.info(sys.exc_info()[0])
...
if __name__ == "__main__":
    ...
    try:
        ...
        bu_alerts.send_mail(
            receiver_email = receiver_email_1,
